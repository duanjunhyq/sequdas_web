...
<tbody>
<tr>
<td> <a href="#" onclick="QCREPORT(event, 'QC3')"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_Intensity-by-cycle_Intensity.png"><a/></td>
<td> <a href="#" onclick="QCREPORT(event, 'QC6')"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-histogram.png"><a/></td>
</tr>
<tr>
<td><a href="#" onclick="QCREPORT(event, 'QC7')"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-heat-map.png"><a/></td>
<td><a href="#" onclick="QCREPORT(event, 'QC8')">  <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_sample-qc.png"><a/></td>
</tr>
</tbody>
</table>
	<!--xxxxxxxxxxxxxxxxxxx -->
  ...
  <p>Index Summary</p>
   <pre>
  		<?php
  				...
  				$file1="../sequdas_result_dir/".$_GET["name"]."/".$_GET["name"]."_index-summary.txt";
  				//echo $file1;
...
<div id="QC3" class="tabcontent">
  ...
  <div align="center"><a href="#" onclick="QCREPORT(event, 'QC1')">  <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_Intensity-by-cycle_Intensity.png"></a></div> 
...
<div id="QC4" class="tabcontent">
	<?php echo "<h3>" . $_GET["id"] . "</h3>";?>
  <p>Plot by Lane</p>
   <div align="center"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_ClusterCount-by-lane.png"></div>
...
<div id="QC5" class="tabcontent">
  ...
  <p>Flowcell Intensity</p>
   <div align="center"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_flowcell-Intensity.png">  </div>
...
<div id="QC6" class="tabcontent">
  ...
  <p> QScore Distribution</p>
   <div align="center"><a href="#" onclick="QCREPORT(event, 'QC1')"> <img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-histogram.png"></a></div>
...
<div id="QC7" class="tabcontent">
  	<?php echo "<h3>" . $_GET["id"] . "</h3>";?>
  <p>Qscore Heatmap</p>
   <div align="center"> <a href="#" onclick="QCREPORT(event, 'QC1')"><img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-heat-map.png"></a></div>
...
<div id="QC8" class="tabcontent">
  	<?php echo "<h3>" . $_GET["id"] . "</h3>";?>
  <p>Sample QC</p>
   <div align="center"> <a href="#" onclick="QCREPORT(event, 'QC1')"><img src="../sequdas_result_dir/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_sample-qc.png"></a></div>
  ...
  <p></p>
		<pre>
  	  	<?php
  				...
  				$file1="../sequdas_result_dir/".$_GET["name"]."/".$_GET["name"]."_summary.txt";
  				//echo $file1;
					$myfile = fopen($file1, "r") or die("Unable to open $file2!");
					echo fread($myfile,filesize($file1));
					fclose($myfile);
  ...
  <p></p>
		<pre>
  	  	<?php
  				...
  				$file1="../sequdas_result_dir/".$_GET["name"]."/"."SampleSheet.csv";
  				//echo $file1;
					$myfile = fopen($file1, "r") or die("Unable to open $file2!");
					echo fread($myfile,filesize($file1));
					fclose($myfile);
