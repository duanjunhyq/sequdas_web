...
<script>
   ...
   function detailFormatter(index, row) {
        var html = [];
        var qc='sequdas_qc_dir/'+row.folder+'/'+row.folder+'_qcreport.html';
        ...
        if(row.status>5) {
            html.push('<table class="table">  <thead><tr><th></th><th>Sample ID</th><th>Sample name</th><th>Project</th><th colspan="2">Kraken (Genus level: >5%)</th><th colspan="2">Kaiju (Genus level: >5%)</th><th>FastQC</th></tr><tbody>');
                ...
                var project = sample_array[i-1].match(regex);
                   ...
                   var jsfile_kraken_taxon="sequdas_qc_dir/"+row.folder+'/'+sample_name+"\_kraken.js";
                   var jsfile_kaiju_taxon="sequdas_qc_dir/"+row.folder+'/'+sample_name+"\_kaiju.js";

                   gettaxon(jsfile_kraken_taxon,i,"kraken");
                   html.push('<td>'+'<p id="clan_kraken'+i+'"></p>'+'</td>');
                   html.push('<td>'+'<a title="Kraken Report"target="_blank" href="sequdas_qc_dir/'+row.folder+'/'+sample_name+"\_krona.out.html"+'"><i class="fa fa-file-image-o" style="font-size:24px;color:#8000ff""></i></span></a>');
                   gettaxon(jsfile_kaiju_taxon,i,"kaiju");
                   html.push('<td>'+'<p id="clan_kaiju'+i+'"></p>'+'</td>');
                   html.push('<td>'+'<a title="Kaiju Report"target="_blank" href="sequdas_qc_dir/'+row.folder+'/'+sample_name+"\_kaiju_krona.out.html"+'"><i class="glyphicon glyphicon-list-alt" style="font-size:24px;color:#ff4000""></i></span></a>');
                   html.push('<td>'+'<a target="_blank" href="/miseq/img/'+row.folder+'/'+sample_name+"\_F.html"+'">Forward</a>&nbsp&nbsp&nbsp'+'<a target="_blank" href="sequdas_qc_dir/'+row.folder+'/'+sample_name+"\_R.html"+'">Reverse</a>'+'</td>');
                   html.push('</tr> ');
        ...
        if(row.status==4) {
            ...
            if(row.status>4) {
                ...
                '">',
                 '<i class="fa fa-bar-chart" style="font-size:24px;color:#E91E63""></i>',
                 '</a>&nbsp&nbsp&nbsp',                 
                   '<a target="_blank" title="MultQC Report" class="like" href="sequdas_qc_dir/',
                row.folder,
                '/',
                row.folder,
                '_qcreport.html',                
